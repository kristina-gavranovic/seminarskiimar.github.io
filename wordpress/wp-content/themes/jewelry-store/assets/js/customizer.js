( function( api ) {
	...
	api.sectionConstructor['jewelry-store-upsale'] = api.Section.extend( {
		...
		_init: function() {
            ...
            control.actions = function ($context) {
                if (control.params.live_title_id) {
                    ...
                    if (control.id === 'jewelry_store_section_order_styling') {
    ...
    function _the_editor( container ){
        var _editor = {
            ...
            ready: function( container ) {
                ...
                control.container.addClass( 'jewelry_store-editor-added' );
...
jQuery( window ).ready( function( $ ){
    ...
    if ( typeof jewelry_store_customizer_settings !== "undefined" ) {
        if (jewelry_store_customizer_settings.number_action > 0) {
            $('.control-section-themes h3.accordion-section-title').append('<a class="theme-action-count" href="' + jewelry_store_customizer_settings.action_url + '">' + jewelry_store_customizer_settings.number_action + '</a>');
        }
    }
     ...
     */
    $( 'select[data-customize-setting-link="jewelry_store_hero_layout"]').on( 'change on_custom_load', function(){
        var v = $( this).val() || '';

        $( "li[id^='customize-control-jewelry_store_hcl']").hide();
        $( "li[id^='customize-control-jewelry_store_hcl"+v+"']").show();

    } );
    $( 'select[data-customize-setting-link="jewelry_store_hero_layout"]').trigger( 'on_custom_load' );


    /**
     * For Gallery content settings
     */
    $( 'select[data-customize-setting-link="jewelry_store_gallery_source"]').on( 'change on_custom_load', function(){
        var v = $( this).val() || '';

        $( "li[id^='customize-control-jewelry_store_gallery_source_']").hide();
        $( "li[id^='customize-control-jewelry_store_gallery_api_']").hide();
        $( "li[id^='customize-control-jewelry_store_gallery_settings_']").hide();
        $( "li[id^='customize-control-jewelry_store_gallery_source_"+v+"']").show();
        $( "li[id^='customize-control-jewelry_store_gallery_api_"+v+"']").show();
        $( "li[id^='customize-control-jewelry_store_gallery_settings_"+v+"']").show();

    } );

    $( 'select[data-customize-setting-link="jewelry_store_gallery_source"]').trigger( 'on_custom_load' );

    /**
     * For Gallery display settings
     */
    $( 'select[data-customize-setting-link="jewelry_store_gallery_display"]').on( 'change on_custom_load', function(){
        var v = $( this).val() || '';
        switch ( v ) {
            case 'slider':
                $( "#customize-control-jewelry_store_g_row_height, #customize-control-jewelry_store_g_col, #customize-control-jewelry_store_g_spacing").hide();
                break;
            case 'justified':
                $( "#customize-control-jewelry_store_g_col, #customize-control-jewelry_store_g_spacing").hide();
                $( "#customize-control-jewelry_store_g_row_height").show();
                break;
            case 'carousel':
                $( "#customize-control-jewelry_store_g_row_height, #customize-control-jewelry_store_g_col").hide();
                $( "#customize-control-jewelry_store_g_col, #customize-control-jewelry_store_g_spacing").show();
                break;
            case 'masonry':
                $( "#customize-control-jewelry_store_g_row_height").hide();
                $( "#customize-control-jewelry_store_g_col, #customize-control-jewelry_store_g_spacing").show();
                break;
            default:
                $( "#customize-control-jewelry_store_g_row_height").hide();
    ...
    $( 'select[data-customize-setting-link="jewelry_store_gallery_display"]').trigger( 'on_custom_load' );
...
jQuery( document ).ready( function( $ ) {
    ...
    var display_footer_layout = function( l ){
        $( 'li[id^="customize-control-jewelrystore_option-footer_custom_"]' ).hide();
        $( 'li[id^="customize-control-jewelrystore_option-footer_custom_'+l+'_columns"]' ).show();
    };

    display_footer_layout( $( '#customize-control-jewelrystore_option-footer_column_layout select' ).val() );
    $( '#customize-control-jewelrystore_option-footer_column_layout select' ).on( 'change', function ()  {
